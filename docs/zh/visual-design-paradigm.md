...
<text x="64" y="34" font-size="20" font-weight="700"
      fill="white" font-family="Microsoft YaHei,sans-serif">临港智算运营平台</text>
```
...
<text x="80" y="260" font-size="12" font-weight="600" letter-spacing="1.4"
      fill="#005792">智算运营 · INTELLIGENT COMPUTE OPERATIONS</text>
<!-- 主标题 -->
<text x="80" y="320" font-size="48" font-weight="700" letter-spacing="-1.0"
      fill="#003D66" font-family="Microsoft YaHei,sans-serif">智算运营服务平台</text>
<!-- 品牌签名条 -->
...
<text x="80" y="372" font-size="18" font-weight="400"
      fill="#3A7FAF" font-family="Microsoft YaHei,sans-serif">
  <tspan x="80" dy="0">让算力的</tspan>
  <tspan fill="#2F9A47" font-weight="700">利用率、效率、性价比</tspan>
  <tspan fill="#3A7FAF">，都做到最优</tspan>
</text>
```
...
## 10. 临港 Premium 落地规格（可复制 SVG defs 与模式）
