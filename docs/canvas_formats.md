...
```bash
# viewBox 应以 0 0 起始
rg 'viewBox="0 0 ' examples

# 常见格式
rg 'viewBox="0 0 1280 720"' examples   # PPT 16:9
rg 'viewBox="0 0 1024 768"' examples   # PPT 4:3
rg 'viewBox="0 0 1242 1660"' examples  # 小红书 3:4
rg 'viewBox="0 0 1080 1080"' examples  # 朋友圈/Instagram 1:1
rg 'viewBox="0 0 1080 1920"' examples  # Story 9:16
rg 'viewBox="0 0 900 383"' examples    # 公众号头图 2.35:1
rg 'viewBox="0 0 1240 1754"' examples  # A4 150dpi
```
