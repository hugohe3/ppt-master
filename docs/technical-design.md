...
opens an independent Step-3 choice: free design, registered library workspaces,
or exact explicit roots supplied for the run. Free design remains the
...
workspaces resolve `templates/design_spec.md`; compatible flat Brand/Layout/Deck
...
read only that project-local copy. The source workspace remains portable between
