...
| 阶段 | 角色 | 关键动作 | 输出物 |
|------|------|----------|--------|
| **1. 策略规划** | Strategist | 七项确认、内容分析、规范编制 | 《设计规范与内容大纲》 |
...
**注意事项**：
- 阶段 1 的七项确认是**强制要求**，不可跳过
- 阶段 1.5 仅当选择「C) AI 生成」图片时触发，是**串行环节**，图片归集完成后才进入阶段 2
...
2. 与Strategist对话（七项确认）
   你: 我需要为小红书创建一份产品使用技巧分享

   Strategist: 在开始之前，我需要完成七项确认：
