...
its retained webpage source packages may run before final confirmation.
Embedded images in those packages are initial source inventory, not independent
web image acquisition. AI / web / slice acquisition runs only from the
