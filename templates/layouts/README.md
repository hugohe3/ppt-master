...
| `中汽研` | 品牌风格 | 产品认证、测评认证、商务拜访 | 深蓝 `#004098` | [经典] 专业权威、咨询风格 |
| `中汽研_v2` | 品牌风格 | 技术展示、高端汇报、发布会 | 科技蓝渐变 `#003366` | [现代] 科技几何、微光质感 |
| `powerchina` | 品牌风格 | 电力能源、工程建设、央企汇报 | 电建蓝 `#00418D` | 大国工匠、稳健厚重 |
...
| `中汽研` | 中汽研风格 (v1 经典版)，适合认证、测评场景 |
| `中汽研_v2` | 中汽研风格 (v2 科技版)，引入几何装饰与渐变设计 |
| `powerchina` | 中国电建风格，适用于电力、能源、工程类央企 |
...
| 日期 | 更新内容 |
|------|----------|
| 2026-01-23 | 添加 `medical_university` 场景专用模板 |
| 2026-01-23 | 将 `powerchina`、`zhongqiyan` 归类为品牌风格，新增 `cmb_bank` 索引 |
| 2026-01-23 | 添加 `government_red`、`government_blue` 政企风格模板 |
| 2026-01-23 | 添加 `google_style` 模板 |
| 2026-01-23 | 重构 README，添加模板索引表和分类 |
| 2026-01-22 | 添加 `pixel_retro` 模板 |
| 2026-01-30 | 升级 `招商银行` (原 cmb_bank) 至 v2.0，采用极简轻奢风格 |
| 2026-01-30 | 新增 `中汽研_v2` (中汽研 v2)，保留原版 `中汽研` 为 v1 |
| 2026-01-22 | 统一模板结构，添加 `02_toc.svg` 和 `design_spec.md` |
