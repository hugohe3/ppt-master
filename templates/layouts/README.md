...
| `中汽研_常规` | 品牌风格 | 产品认证、测评认证、商务拜访 | 深蓝 `#004098` | [常规] 专业权威、咨询风格 |
| `中汽研_现代` | 品牌风格 | 技术展示、高端汇报、发布会 | 科技蓝渐变 `#003366` | [现代] 科技几何、微光质感 |
...
| `中汽研_现代` | 中汽研现代风格 (v2 科技版)，引入几何装饰与渐变设计 |
...
| 2026-01-30 | 重构 `中汽研` / `中国电建` 系列，推出 `_经典` 与 `_现代` 双版本 |
