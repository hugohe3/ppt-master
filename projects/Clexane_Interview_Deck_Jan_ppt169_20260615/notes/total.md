# Speaker Notes — Clexane Interview Deck (Jan)
...
From PMK, I would build out to Ramathibodi — where I already have relationships from my Roche internship — and Bhumibol Adulyadej Hospital, which has a significant trauma and surgical caseload. Chulalongkorn offers an academic KOL opportunity. Phyathai and the Paolo network would be a Tier 2 pipeline for later in the year.

For physician prioritization, I would start with Priority A accounts: cardiologists at PMK for the ACS use case, and orthopedic surgeons at PMK for post-operative VTE prophylaxis. Both are twice-weekly call targets. Priority B would be internists at Ramathibodi and hematologists at Chulalongkorn — weekly visits once the PMK relationships are established.

My Roche experience matters here specifically because I know how to navigate a busy academic hospital. I know the gatekeeper structure, the scheduling rhythm, and how to be respectful of physician time while still being effective.
...
A is Assess: before I walk in, I review the physician's specialty, patient mix, and current prescribing behavior. I prepare relevant data rather than walking in cold.

D is Discover: in the call, I ask open questions to surface the physician's actual challenges. "What concerns do you have with your current anticoagulation approach?" I listen much more than I talk at this stage.

A is Activate: once I understand their need, I connect Clexane's evidence to that specific problem. If a cardiologist is worried about monitoring burden in the ICU, I lead with the no-aPTT-monitoring advantage and back it with the ESSENCE data.

P is Project: I help the physician visualize the patient outcome. "Your DVT patients can be discharged a day earlier because they can self-administer at home." Making the benefit tangible is what moves prescribing behavior.

T is Tie Down: I always leave with a concrete next step agreed. That might be a trial case, a follow-up appointment, or a commitment to try Clexane on specific patient types.

I used this approach at Roche — I described a real example of getting a cardiologist at Bhumibol to agree to a Clexane pilot in one call by working through all five steps.
...
I came in prepared because Clexane matters. This product has strong evidence, a clear place in Thai acute care medicine, and I want to be the person who brings that message to PMK and the broader Bangkok network.
