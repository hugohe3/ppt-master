...
curl -LO https://github.com/elvisw/ppt-master/releases/latest/download/ppt_master-0.1.0-py3-none-any.whl
uv tool install ppt_master-0.1.0-py3-none-any.whl
```
