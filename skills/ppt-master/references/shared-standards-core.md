...
| Number and punctuation conventions | Digit grouping, decimal marks, quotation marks, and the space before `%` follow the content language — a consumer audience's everyday usage over the standards-body spelling — and one choice holds deck-wide. |
