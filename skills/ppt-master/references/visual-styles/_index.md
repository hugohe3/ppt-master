...
| Quick Generate | The current main agent decides its one direction with this index closed, then opens it once to map, then reads the resolved preset or exact custom bases and retains that one direction without Design Spec/lock. |
