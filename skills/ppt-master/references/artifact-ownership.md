...
| `exports/svg_quality_report.json` | `svg_output/`, locks, template provenance | `uvx ppt-master svg-quality-check <project_path> --stage final --json` |
| Native PPTX + `<output_stem>.report.json` | `svg_output/` plus notes/assets and final quality report | `uvx ppt-master svg-to-pptx <project_path>` |
