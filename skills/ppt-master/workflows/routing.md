...
| Delivered project comes back with a revision (wording, an added or dropped page, a palette) | Stay in Generate: [`generate-pptx.md`](./generate-pptx.md) Revision Round, then the final quality gate and Step 7 |
