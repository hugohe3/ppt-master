...
3. Validate: `uvx ppt-master svg-quality-check templates/layouts/<id> --template-mode --format ppt169`
4. Register: `uvx ppt-master register-template <id> --kind layout`
