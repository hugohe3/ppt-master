...
kind: style
summary: Answer-first, evidence-led decision-document method at strategy-document density — numbered exhibits, key-message column, footnotes, and action titles on every page.
keywords: [consulting, decision-support, answer-first, evidence, document-density]
---
...
| Sources | [GitHub Issue #241](https://github.com/hugohe3/ppt-master/issues/241), opened 2026-07-22; reusable brief confirmed 2026-08-04; document-density page conventions confirmed 2026-09-05 from the EV market-priority deck (`projects/ev_strategy_mck_20260905`) |
