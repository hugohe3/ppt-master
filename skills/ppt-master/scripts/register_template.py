...
Usage::
    ...
    uvx ppt-master register-template <id> --kind deck     # default kind=deck
    uvx ppt-master register-template <id> --kind layout
    uvx ppt-master register-template <id> --kind brand
    uvx ppt-master register-template <id> --kind style
    uvx ppt-master register-template --rebuild-all --kind deck
    uvx ppt-master register-template <id> --dry-run
