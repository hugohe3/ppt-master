...
REVIEW = {
    ...
    # ---- batch 4: keys 73-96 ----
    73: dict(type="layered-platform", slots=6, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="architecture panorama with image header"),
    74: dict(type="framework",        slots=5, footprint="wide-band",        text_load="medium", motif="mixed"),
    75: dict(type="layered-platform", slots=4, footprint="full-bleed",       text_load="heavy",  motif="ring",  subform="large concentric rings"),
    76: dict(type="layered-platform", slots=4, footprint="wide-band",        text_load="medium", motif="mixed"),
    77: dict(type="framework",        slots=3, footprint="wide-band",        text_load="medium", motif="card"),
    78: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    79: dict(type="flowchart",        slots=4, footprint="wide-band",        text_load="medium", motif="cube",  subform="training inputs -> central stack -> API outputs"),
    80: dict(type="layered-platform", slots=5, footprint="centered-compact", text_load="medium", motif="ring",  subform="concentric rings"),
    81: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    82: dict(type="layered-platform", slots=3, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="3 stacked field platforms (public/mind/private)"),
    83: dict(type="bowtie",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    84: dict(type="bowtie",           slots=4, footprint="wide-band",        text_load="medium", motif="mixed"),
    85: dict(type="framework",        slots=6, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="capability panorama"),
    86: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="ring",  subform="concentric funnel rings"),
    87: dict(type="layered-platform", slots=5, footprint="wide-band",        text_load="medium", motif="sphere"),
    88: dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    89: dict(type="bowtie",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    90: dict(type="pyramid",          slots=4, footprint="tall-center",      text_load="medium", motif="mixed"),
    91: dict(type="framework",        slots=5, footprint="wide-band",        text_load="medium", motif="mixed", subform="radial hub + stat panel"),
    92: dict(type="bowtie",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    93: dict(type="framework",        slots=8, footprint="full-bleed",       text_load="heavy",  motif="sphere", subform="dense radial panorama"),
    94: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="ring",  subform="concentric rings + side stats"),
    95: dict(type="framework",        slots=5, footprint="wide-band",        text_load="medium", motif="mixed"),
    96: dict(type="funnel",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    # ---- batch 5: keys 97-120 ----
    97:  dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    98:  dict(type="flowchart",        slots=5, footprint="wide-band",        text_load="medium", motif="mixed", subform="funnel inputs -> layered platform"),
    99:  dict(type="framework",        slots=4, footprint="wide-band",        text_load="medium", motif="sphere"),
    100: dict(type="layered-platform", slots=5, footprint="wide-band",        text_load="medium", motif="mixed"),
    101: dict(type="cycle",            slots=6, footprint="centered-compact", text_load="medium", motif="sphere"),
    102: dict(type="framework",        slots=4, footprint="wide-band",        text_load="light",  motif="sphere"),
    103: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    104: dict(type="pyramid",          slots=4, footprint="tall-center",      text_load="medium", motif="mixed"),
    105: dict(type="framework",        slots=5, footprint="wide-band",        text_load="heavy",  motif="mixed"),
    106: dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    107: dict(type="layered-platform", slots=4, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="fan/arc panorama"),
    108: dict(type="layered-platform", slots=4, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="concentric funnel + side stats"),
    109: dict(type="matrix",           slots=8, footprint="full-bleed",       text_load="heavy",  motif="card",  subform="architecture grid"),
    110: dict(type="bowtie",           slots=5, footprint="full-bleed",       text_load="heavy",  motif="mixed"),
    111: dict(type="layered-platform", slots=3, footprint="centered-compact", text_load="medium", motif="mixed", subform="tiered method platform (Scale/Conversion/Image)"),
    112: dict(type="matrix",           slots=4, slot_of="columns", footprint="wide-band", text_load="heavy", motif="card", subform="4-column card matrix"),
    113: dict(type="flowchart",        slots=5, footprint="wide-band",        text_load="medium", motif="mixed", subform="inputs -> central processing -> outputs"),
    114: dict(type="bowtie",           slots=3, footprint="wide-band",        text_load="medium", motif="cube",  subform="API lifecycle bowtie (cylinder stages)"),
    115: dict(type="framework",        slots=2, footprint="wide-band",        text_load="medium", motif="sphere", subform="two overlapping circles (venn)"),
    116: dict(type="bowtie",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    117: dict(type="bowtie",           slots=4, footprint="wide-band",        text_load="medium", motif="mixed"),
    118: dict(type="framework",        slots=6, footprint="centered-compact", text_load="medium", motif="sphere", subform="radial hub on platform"),
    119: dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    120: dict(type="pyramid",          slots=4, footprint="tall-center",      text_load="medium", motif="mixed"),
    # ---- batch 6: keys 121-144 (145 non-diagram) ----
    121: dict(type="pyramid",          slots=3, footprint="centered-compact", text_load="medium", motif="mixed"),
    122: dict(type="matrix",           slots=4, slot_of="columns", footprint="full-bleed", text_load="heavy", motif="card", subform="hub + 4-column architecture base"),
    123: dict(type="layered-platform", slots=4, footprint="full-bleed",       text_load="heavy",  motif="ring",  subform="concentric cloud platform"),
    124: dict(type="framework",        slots=5, footprint="wide-band",        text_load="heavy",  motif="mixed", subform="central platform + left/right node columns"),
    125: dict(type="layered-platform", slots=5, footprint="wide-band",        text_load="heavy",  motif="card"),
    126: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="ring",  subform="concentric funnel rings"),
    127: dict(type="bowtie",           slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    128: dict(type="layered-platform", slots=3, footprint="full-bleed",       text_load="heavy",  motif="ring",  subform="cloud stack (IaaS/PaaS/SaaS) concentric", scenario="cloud stack (IaaS/PaaS/SaaS)"),
    129: dict(type="matrix",           slots=8, footprint="full-bleed",       text_load="heavy",  motif="card",  subform="architecture grid"),
    130: dict(type="matrix",           slots=4, slot_of="columns", footprint="full-bleed", text_load="heavy", motif="card", subform="4-column layered architecture"),
    131: dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    132: dict(type="layered-platform", slots=6, footprint="full-bleed",       text_load="heavy",  motif="mixed", subform="data-wall platform panorama"),
    133: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    134: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="ring",  subform="concentric platform"),
    135: dict(type="layered-platform", slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    136: dict(type="pyramid",          slots=4, footprint="centered-compact", text_load="medium", motif="mixed"),
    137: dict(type="framework",        slots=8, footprint="centered-compact", text_load="medium", motif="sphere", subform="radial hub (brand journey)"),
    138: dict(type="cycle",            slots=5, footprint="centered-compact", text_load="medium", motif="ring",  subform="segmented ring"),
    139: dict(type="cycle",            slots=4, footprint="centered-compact", text_load="medium", motif="ring",  subform="segmented donut + callouts"),
    140: dict(type="framework",        slots=6, footprint="wide-band",        text_load="medium", motif="sphere", subform="knowledge graph (central + branches)", scenario="knowledge graph / entity relationships"),
