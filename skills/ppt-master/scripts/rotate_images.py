...
def main():
    ...
    if command == 'gen':
        if len(sys.argv) < 3:
            ...
            print("用法: python3 scripts/rotate_images.py gen <images_directory>")
            sys.exit(1)
        ...
        if len(sys.argv) < 3:
            ...
            print("用法: python3 scripts/rotate_images.py fix <fixes.json>")
            sys.exit(1)
        ...
        if len(sys.argv) < 3:
            print("[ERROR] 错误: 需要提供图片目录路径")
            print("用法: python3 scripts/rotate_images.py auto <images_directory>")
            sys.exit(1)
