...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content.append(
        "2. 验证项目: `python3 scripts/project_manager.py validate examples/<project>`")
    content.append("3. 更新索引: `python3 scripts/generate_examples_index.py`")
    content.append("4. 提交 Pull Request\n")

    # 相关资源
    content.append("## [Resources] 相关资源\n")
    content.append("- [快速开始](../README.md)")
    content.append("- [工作流教程](../../AGENTS.md)")
    content.append("- [设计规范](../references/design-guidelines.md)")
    content.append("- [画布格式](../references/canvas-formats.md)")
    content.append("- [角色定义](../references/)")
