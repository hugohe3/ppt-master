...
| Project management | `project_manager.py`, `workflow_log.py`, `workflow_transcript.py`, `batch_validate.py`, `generate_examples_index.py`, `error_helper.py`, `pptx_template_import.py`, `pptx_design_extractor.py`, `pptx_delivery_check.py` | [docs/project.md](./docs/project.md); [docs/template-tools.md](./docs/template-tools.md) |
