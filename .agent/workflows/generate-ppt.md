...
>
> 📖 **规则手册**：执行本流程时，**必须同时遵守 [AGENTS.md](../../AGENTS.md)** 中的所有规则与约束。
...
|------|------|------|
| **本工作流** | 执行流程 | "做什么"（步骤顺序） |
| **[AGENTS.md](../../AGENTS.md)** | 规则手册 | "怎么做"（约束边界、技术规范） |
| **[roles/](../../roles/)** | 角色定义 | "谁来做"（专业能力、职责范围） |

> ⚠️ **强制要求**：执行任何步骤前，必须先阅读 [AGENTS.md](../../AGENTS.md) 中的「角色切换协议」章节。
