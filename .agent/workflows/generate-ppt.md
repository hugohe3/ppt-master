...
→ Strategist 完成大纲后，调用 Template_Designer 生成模板
...
5. **阶段检查点**：
   ...
   - [x] 已生成《设计规范与内容大纲》
   - [x] 设计规范已保存到项目文件夹
   - [ ] **下一步**: [Template_Designer/Image_Generator/Executor_xxx]
   ```

---

## 阶段五：Template_Designer 角色（条件触发）

> **触发条件**：模板选项 = C（生成新模板）且 Strategist 完成后

1. **阅读角色定义**：
   ```
   view_file: roles/Template_Designer.md
   ```

2. **生成页面模板**：保存到 `<项目路径>/templates/`
