...
- **18pt 基准（默认推荐）**: 标准演示、汇报、培训
- **14pt 基准（备选）**: 仅当内容过多、单页信息密集时使用

> 💡 **原则**: 优先保证可读性，18pt 是正文字号的最低推荐值。只有确实无法容纳内容时，才考虑降至 14pt。

| 用途     | 比例   | 18pt基准（默认） | 14pt基准（备选） |
| -------- | ------ | ---------------- | ---------------- |
| 封面标题 | 2.5-3× | 45-54pt          | 35-42pt          |
| 内容标题 | 1.5-2× | 27-36pt          | 21-28pt          |
| **正文** | **1×** | **18pt**         | **14pt**         |
| 注释     | 0.75×  | 14pt             | 11pt             |
