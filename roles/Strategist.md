...
---\n
## 1.5 图片资源扫描（针对“已有图片”模式）

如果用户在第 g 项确认中选择了 **“B) 用户提供”**，你**必须**执行以下操作：
...
4.  **基于图片规划布局**：在「内容大纲」中规划具体页面时，**必须根据图片比例选择布局**。
    *   **竖图 (< 0.8)**：规划为“左右分栏”或“左图右文”布局。
    *   **标准横图 (1.3-1.6)**：规划为“标准插图”或“全屏背景”。
    *   **超宽图 (> 2.0)**：规划为“上下分割”或“页眉/页脚通栏”。
